  ...
  Future<void> getDataDetailPeminjaman(String? idPinjam) async {
    ...
    try {
      final responseDetailBuku = await ApiProvider.instance()
          .get('${Endpoint.detailPeminjaman}/$idPinjam');

      if (responseDetailBuku.statusCode == 200) {
        final ResponseDetailPeminjaman responseDetailPeminjaman =
            ResponseDetailPeminjaman.fromJson(responseDetailBuku.data);
